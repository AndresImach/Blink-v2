...
export const mockBusinesses: Business[] = [
  {
    ...
    description:
      "Global coffeehouse chain known for premium coffee and cozy atmosphere",
    rating: 4.5,
  ...
  },
  {
    ...
    location: "Nationwide",
    image:
      "https://images.pexels.com/photos/33488/gasoline-gas-station-refuel-gas.jpg?auto=compress&cs=tinysrgb&w=400",
    benefits: [
      {
        bankName: "Chase",
  ...
  },
  {
    ...
    category: "retail",
    description:
      "Popular retail chain offering everything from groceries to home goods",
    rating: 4.3,
    location: "Multiple locations",
    image:
  ...
  },
  {
    ...
    category: "grocery",
    description:
      "Premium grocery chain specializing in organic and natural foods",
    rating: 4.4,
    location: "Multiple locations",
    image:
  ...
  },
  {
    ...
    description:
      "Leading streaming entertainment service with original content",
    rating: 4.1,
